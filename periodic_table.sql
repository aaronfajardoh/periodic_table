...
--
-- Name: properties properties_types_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_types_fkey FOREIGN KEY (type_id) REFERENCES public.types(type_id);
